...
struct stats_tcpx{
	...
	unsigned long long tcplistenq;					// set to zero than never change
	unsigned long long tcplistenincq;				// set to zero than ....
	unsigned long long tcplistenover;
	unsigned long long tcpnconnest;
	unsigned long long tcpnconndrop;					//set to zero than ...
	unsigned long long tcpembdrop;
	unsigned long long tcprexmitdrop;
	unsigned long long tcppersistdrop;				// set to zero than ..,
	unsigned long long tcpkadrop;					//set to zero than ...
};

static void read_stat_tcpx(struct module *mod)
{
	FILE *fp_tcp;
	FILE *fp_snmp;
	FILE *fp_netstat;
