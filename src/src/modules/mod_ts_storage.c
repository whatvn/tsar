...
void set_ts_storage_record(struct module *mod, double st_array[],
...
{
  register_mod_fileds(mod, "--ts_storage", ts_storage_usage, ts_storage_info, 4, read_ts_storage_stats, set_ts_storage_record);
}
