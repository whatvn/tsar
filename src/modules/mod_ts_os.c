...
void set_ts_os_record(struct module *mod, double st_array[],
...
void read_ts_os_stats(struct module *mod)
{
  int fd = -1;
...
{
  register_mod_fileds(mod, "--ts_os", ts_os_usage, ts_os_info, 4, read_ts_os_stats, set_ts_os_record);
}
